...
namespace LifeGame
{
    public partial class frmBibPhDThesis : Form
    {
        ...
        public frmBibPhDThesis(CLiterature inputLiterature, RLiteratureAuthor inputAuthor)
        {
            InitializeComponent();
            literature.BibEntry = EBibEntry.Phdthesis;
            ...
            {
                if (inputLiterature.BibEntry != EBibEntry.Phdthesis)
                {
            ...
            txtBibTeX.Text = ParseBib.ParseBibTeXPhdthesis(literature, dateAdded, DateTime.Today);
        }
